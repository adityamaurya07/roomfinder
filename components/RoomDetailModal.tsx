...
export default function RoomDetailModal({ room, onClose }: RoomDetailModalProps) {
  ...
  const [seekerPhone, setSeekerPhone] = useState<string>('');
      ...
      <div className="relative w-full max-w-4xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden my-8">
        ...
        <div className="p-5 sm:p-7 space-y-6 max-h-[calc(85vh-350px)] overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
            ...
            <div className="sm:text-right shrink-0 bg-emerald-50 dark:bg-emerald-950/40 p-3.5 rounded-xl border border-emerald-100 dark:border-emerald-900">
              ...
              <div className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium">
                {room.maintenanceIncluded ? '✓ Maintenance Included' : 'Maintenance extra'}
              </div>
            </div>
          </div>
          ...
          {/* Host Card & Quick Connect */}
          <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/40 dark:to-teal-950/40 border border-emerald-200 dark:border-emerald-800/60">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full bg-emerald-600 text-white font-bold flex items-center justify-center text-base shadow">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 sm:flex-initial px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm transition shadow-md shadow-emerald-600/20 flex items-center justify-center gap-2"
                >
                ...
                {room.contact.phone && (
                  <a
                    ...
                    className="flex-1 sm:flex-initial px-5 py-2.5 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 font-bold text-sm transition shadow-md flex items-center justify-center gap-2"
                  >
